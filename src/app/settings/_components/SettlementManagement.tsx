                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex flex-col">
                    ...
                    <div className="flex items-center gap-1.5 mt-1">
                        <div className={cn("h-1.5 w-1.5 rounded-full", item.unsettledAmount > 0 ? "bg-amber-500 animate-pulse" : "bg-emerald-500")} />
                        <p className="text-[10px] text-muted-foreground uppercase tracking-widest font-black">
                            {item.unsettledAmount > 0 ? 'Omzet Belum Cair' : 'Semua Omzet Telah Cair'}
                        </p>
                    </div>
                  </div>
                </div>

                {/* Main Content Section: Nominal */}
